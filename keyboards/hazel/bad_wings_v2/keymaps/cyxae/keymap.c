...
// Left Ctrl + G = Ctrl + A
const key_override_t lctrl_g_override = ko_make_basic(MOD_BIT(KC_LCTL), KC_G, C(KC_SCLN));

// Left Ctrl + B = Ctrl + X
const key_override_t lctrl_b_override = ko_make_basic(MOD_BIT(KC_LCTL), KC_T, C(KC_P));
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [L_NUM] = LAYOUT_split_3x5_3(
    ...
    KC_NO,      KC_F4,      KC_F5,      KC_F6,      KC_F11,           KC_NUM,     KC_4,       KC_5,       KC_6,       KC_0,
    KC_TRNS,    KC_F1,      KC_F2,      KC_F3,      KC_F12,           KC_NO,      KC_1,       KC_2,       KC_3,       KC_NO,
                            KC_TRNS,    KC_TRNS,    KC_TRNS,          KC_TRNS,    KC_TRNS,    KC_NO
  ),
  [L_NAV] = LAYOUT_split_3x5_3(
    KC_WBAK,    ALT_TAB,    C(KC_SLSH), KC_WFWD,    ALT_F4,           S(KC_INS),  KC_HOME,    KC_PGDN,    KC_PGUP,    KC_END,
